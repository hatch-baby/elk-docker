...
# Elasticsearch, Logstash, Kibana 9.5.2
...
ADD ./logstash.yml ${LOGSTASH_PATH_SETTINGS}/logstash.yml
...
RUN curl -L -u ${GEOLITE_ACCOUNT_ID}:${GEOLITE_LICENSE_KEY} "https://download.maxmind.com/geoip/databases/GeoLite2-City/download?suffix=tar.gz" -o /tmp/GeoLiteCity.tar.gz &&\
